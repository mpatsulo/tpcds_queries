...
with ssr as(
    ...
    from (
        ...
        from
          tpcds_sf1.store_returns) salesreturns,
      tpcds_sf1.date_dim,
      tpcds_sf1.store
    where
...
csr as (
    ...
    from (
        ...
        from tpcds_sf1.catalog_returns) salesreturns,
      tpcds_sf1.date_dim,
...
results as (
    ...
    from (
      select
        ...
        'tpcds_sf1.store' || s_store_id as id,
        sales,
        returns,
      ...
      select
        ...
        'tpcds_sf1.catalog_page' || cp_catalog_page_id as id,
        sales,
        returns,
        (profit - profit_loss) as profit
      from
