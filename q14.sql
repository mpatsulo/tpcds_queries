...
with cross_items as (
  ...
  from tpcds.item, (
      ...
      from
        tpcds.store_sales, tpcds.item iss, tpcds.date_dim d1
      where
      ...
      select
        ...
        ics.i_category_id
      from
        tpcds.catalog_sales, tpcds.item ics, tpcds.date_dim d2
      where
      ...
      select
        ...
        iws.i_category_id
      from
        tpcds.web_sales, tpcds.item iws, tpcds.date_dim d3
      where
...
avg_sales as (
  ...
  from (
      ...
      from
        tpcds.catalog_sales, tpcds.date_dim
      where
...
from (
    select
      ...
      count(*) number_sales
    from
      tpcds.store_sales, tpcds.item, tpcds.date_dim
    where
