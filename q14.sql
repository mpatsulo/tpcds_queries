...
with cross_items as (
  ...
  from tpcds_sf1.item, (
      ...
      from
        tpcds_sf1.store_sales, tpcds_sf1.item iss, tpcds_sf1.date_dim d1
      where
      ...
      select
        ...
        ics.i_category_id
      from
        tpcds_sf1.catalog_sales, tpcds_sf1.item ics, tpcds_sf1.date_dim d2
      where
      ...
      select
        ...
        iws.i_category_id
      from
        tpcds_sf1.web_sales, tpcds_sf1.item iws, tpcds_sf1.date_dim d3
      where
...
avg_sales as (
  ...
  from (
      ...
      from
        tpcds_sf1.catalog_sales, tpcds_sf1.date_dim
      where
...
from (
    select
      ...
      count(*) number_sales
    from
      tpcds_sf1.store_sales, tpcds_sf1.item, tpcds_sf1.date_dim
    where
