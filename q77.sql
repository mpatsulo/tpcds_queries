...
(SELECT
  ...
  FROM tpcds.store_returns, tpcds.date_dim, tpcds.store
  ...
  FROM tpcds.catalog_returns, tpcds.date_dim
  ...
  FROM tpcds.web_sales, tpcds.date_dim, tpcds.web_page
  ...
  FROM tpcds.web_returns, tpcds.date_dim, tpcds.web_page
